...
print(classification_report(y_test, y_pred_rnn, target_names=iris.target_names))
...
print(classification_report(y_test_dense, y_pred_dense, target_names=iris.target_names))
