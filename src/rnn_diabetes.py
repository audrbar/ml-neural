...
initial_df = pd.read_csv('/Users/audrius/Documents/VCSPython/ml-neural/data/diabetes.csv')
...
print(classification_report(y_test, y_pred_rnn, target_names=['No Diabetes', 'Diabetes']))
...
print(classification_report(y_test_dense, y_pred_dense, target_names=['No Diabetes', 'Diabetes']))
